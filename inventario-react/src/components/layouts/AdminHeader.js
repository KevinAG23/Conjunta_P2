            ...
            <ul className="navbar-nav topbar-nav ml-md-auto align-items-center">
              <li className="nav-item dropdown">
                ...
                >
                  ...
                  />
                  <span>{userName !== "" ? userName : "Nombre de usuario"}</span>{" "}
                </a>
                <ul className={`dropdown-menu dropdown-user ${showDropDown ? "show" : ""}`}>
                  <li>
                    <div className="user-box">
                      ...
                      <div className="u-text">
                        <h4>{userName !== "" ? userName : "Nombre de usuario"}</h4>
                        <p className="text-muted">
                          {emailAddress !== "" ? emailAddress : "Correo electrónico"}
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <Link className="dropdown-item" to="/profile">
                    <i className="fa fa-power-off"></i> Perfil
                  </Link>
                  <div className="dropdown-divider"></div>
